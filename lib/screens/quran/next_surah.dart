...
class NextSurah extends StatefulWidget {
  final Surah surahDetails;

  const NextSurah({Key? key, required this.surahDetails}) : super(key: key);

  @override
  State<NextSurah> createState() => _NextSurahState();
}

class _NextSurahState extends State<NextSurah> {
                                        ...
                                        child: Container(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () async {
                                             ...
                                             previous_surah_id=previous_surah_id-1;
                                             print("previous id: "+previous_surah_id);
                                              ...
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(builder: (context) =>  NextSurah(surahDetails: _surah[previous_surah_id],)),
                                              );
